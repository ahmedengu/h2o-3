...
//              _dinfo.responseChunkId(1), 1).doAll(augZW);
 ...
 //     CalculateW4Data calculateW4Data = calculateNewWAugXZ(augXZ, _randC);
      ...
      cleanupHGLMMemory(null, new Frame[]{glmmmeReturnFrame, hvDataOnly}, null, null);
    }
...
//        });
    ...
    private Frame formAMatrix(Frame hlikH, Frame augXZ) {
      ...
      cleanupHGLMMemory(null, new Frame[]{dataFrame, leftUp, augzW1, tX, tXW1z, leftDown}, null, null);
    ...
    private Frame formHMatrix(Frame augXZ) {
      ...
      double[][] W2 = null;
      W2 = ArrayUtils.transpose(new ArrayUtils.FrameToArray(1,1, wranddata.numRows(), W2).doAll(_state.get_priorw_wpsi()).getArray());
      ArrayUtils.mult(W2[0], W2[0]);        // generate W2 square
      dgram._gram.addDiag(W2[0]);
      cleanupHGLMMemory(new DataInfo[]{augZW1Info}, new Frame[]{augZW1}, null, null);
